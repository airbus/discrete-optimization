...
#### Define environment variables for notebook github links  [optional]

In order to define appropriate github, binder, and colab links for notebooks,
...
If you skip this part, the python script "generate_nb_index.py" will try to use the above commands to fill the variables.
