...
from discrete_optimization.maximum_independent_set.solvers.mis_lns import (
    ...
    MisOrtoolsCPSatConstraintHandlerDestroy,
...
class LNS_OrtoolsCPSat_Mix(LNS_OrtoolsCPSat):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        LNS_OrtoolsCPSat_Mix.generated_constraint_handlers.append(constraint_handler)
...
def test_lns_mix(random_seed):
    ...
    solvers_to_test = [LNS_OrtoolsCPSat_Mix]
    ...
    assert len(LNS_OrtoolsCPSat_Mix.generated_constraint_handlers) == n_trials

    represented_classes = set()
    for c in LNS_OrtoolsCPSat_Mix.generated_constraint_handlers:
    ...
    assert MisOrtoolsCPSatConstraintHandlerAllVars in represented_classes
    assert MisOrtoolsCPSatConstraintHandlerDestroy in represented_classes
