...
@pytest.mark.parametrize(
    "subtour_do_order, subtour_do_order_use_indicator, include_subtour",
    [
        (False, False, False),
        (True, False, False),
        (True, True, False),
...
def test_tsp_new_api(
    solver_class,
    subtour_do_order,
    subtour_do_order_use_indicator,
    subtour_consider_only_first_component,
    include_subtour,
):
    ...
    linear_flow_solver.init_model(
        ...
        subtour_do_order_use_indicator=subtour_do_order_use_indicator,
...
@pytest.mark.parametrize(
    "subtour_do_order, subtour_do_order_use_indicator",
