...
def load_psplib_preemptive_model_1() -> PreemptiveRcpspProblem:
    ...
    return PreemptiveRcpspProblem(
        ...
        source_task=None,
        sink_task=None,
        preemptive_indicator={k: False for k in range(rcpsp_problem.n_jobs)},
        name_task=None,
    )


def load_psplib_preemptive_model_2(filename) -> PreemptiveRcpspProblem:
    files = get_data_available()
