...
from discrete_optimization.coloring.solvers.coloring_lp_lns_solvers import (
    ConstraintHandlerFixColorsGrb,
    ConstraintHandlerFixColorsMathOpt,
)
...
@pytest.mark.parametrize(
    ...
    [
        (ColoringLPMathOpt, ConstraintHandlerFixColorsMathOpt),
        (ColoringLP, ConstraintHandlerFixColorsGrb),
    ],
)
