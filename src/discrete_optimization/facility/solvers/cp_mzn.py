...
class CpFacilityModel(Enum):
    DEFAULT_INT = 0
    DEFAULT_INT_LNS = 1


file_dict = {
    CpFacilityModel.DEFAULT_INT: "facility_int.mzn",
    CpFacilityModel.DEFAULT_INT_LNS: "facility_int_lns.mzn",
}


class CpFacilitySolver(MinizincCpSolver, FacilitySolver):
    ...
    hyperparameters = [
        EnumHyperparameter(
            "cp_model", enum=CpFacilityModel, default=CpFacilityModel.DEFAULT_INT
        ),
        EnumHyperparameter(
    ...
    def init_model(self, **kwargs: Any) -> None:
        ...
        if model_type in [CpFacilityModel.DEFAULT_INT, CpFacilityModel.DEFAULT_INT_LNS]:
            distances_list = [
