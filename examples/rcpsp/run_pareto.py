...
def run_single_mode_robustness_benchmark():
    ...
    sol_perm_2 = [
        rcpsp_problem.n_jobs_non_dummy - 1 - i
        for i in range(rcpsp_problem.n_jobs_non_dummy)
    ]
    sol_perm_3 = [i for i in range(rcpsp_problem.n_jobs_non_dummy)]
    ...
    sol_1 = RcpspSolution(problem=rcpsp_problem, rcpsp_permutation=sol_perm_1)
    sol_2 = RcpspSolution(problem=rcpsp_problem, rcpsp_permutation=sol_perm_2)
    sol_3 = RcpspSolution(problem=rcpsp_problem, rcpsp_permutation=sol_perm_3)
    ...
    kwargs = {"rcpsp_permutation": s_pure_int, "problem": rcpsp_problem}
    problem_sol = rcpsp_problem.get_solution_type()(**kwargs)
