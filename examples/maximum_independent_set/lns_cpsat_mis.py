...
def run_lns():
    ...
    # constraint_handler = MisOrtoolsCPSatConstraintHandlerLocalMoves(
...
def run_lns_mix():
    ...
    list_constraints_handler = [
        MisOrtoolsCPSatConstraintHandlerAllVars(problem=mis_model, fraction_to_fix=0.8),
        MisOrtoolsCPSatConstraintHandler(problem=mis_model, fraction_to_fix=0.8),
