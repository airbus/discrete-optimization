...
if __name__ == "__main__":
    ...
    create_another_study = (
        True  # avoid relaunching the same study, keep the previous ones
    )
    ...
    # we create an instance of TspProblem
    problem = Point2DTspProblem([p1, p2, p3, p4, p5], 5, start_index=0, end_index=4)

    modelfilename = "tsp_quantum_solvers"
    ...
    def objective(trial: Trial):
        ...
        if len(res.list_solution_fits) != 0:
            ...
            trial.set_user_attr("permutation", sol.permutation)
            return fit
        else:
