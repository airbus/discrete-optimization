...
from discrete_optimization.tsp.tsp_model import SolutionTSP, TSPModel2D, length
...
class TSP2dQiskit(OptimizationApplication):
    def __init__(self, problem: TSPModel2D) -> None:
        """
        Args:
...
class QAOATSPSolver(SolverTSP, QiskitQAOASolver):
    def __init__(
        self,
        problem: TSPModel2D,
...
class VQETSPSolver(SolverTSP, QiskitVQESolver):
    def __init__(
        self,
        problem: TSPModel2D,
        params_objective_function: Optional[ParamsObjectiveFunction] = None,
