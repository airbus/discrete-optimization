...
class TSPModelDistanceMatrix(TSPModel):
    def __init__(self,
                 ...
                 end_index: int = 0,
                 use_numba=True):
        TSPModel.__init__(self, list_points=list_points,
...
@njit
def compute_length_matrix(start_index,
                          end_index,
                          solution: Union[List[int], np.array],
                          distance_matrix: np.array,
                          node_count,
...
def build_evaluate_function_matrix(tsp_model: TSPModelDistanceMatrix):
    return partial(compute_length_matrix, start_index=tsp_model.start_index,
                   end_index=tsp_model.end_index,
