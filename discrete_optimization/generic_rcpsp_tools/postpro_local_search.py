...
from discrete_optimization.rcpsp_multiskill.rcpsp_multiskill import MS_RCPSPSolution_Preemptive
...
class PostProLocalSearch(PostProcessSolution):
    ...
    def build_other_solution(self, result_storage: ResultStorage) -> ResultStorage:
        ...
        if isinstance(s, MS_RCPSPSolution_Preemptive): # TODO : check if other cases fail. probably MS_RCPSPSolution
            from discrete_optimization.rcpsp_multiskill.rcpsp_multiskill \
                import schedule_solution_preemptive_to_variant
