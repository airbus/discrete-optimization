...
import numpy as np
from discrete_optimization.vrp.vrp_model import length, BasicCustomer, VrpProblem, \
    VrpProblem2D, VrpSolution, Customer2D
from discrete_optimization.vrp.vrp_toolbox import compute_length_matrix, build_graph
...
first_solution_map = {FirstSolutionStrategy.SAVINGS: routing_enums_pb2.FirstSolutionStrategy.SAVINGS,
                      FirstSolutionStrategy.PATH_MOST_CONSTRAINED_ARC: routing_enums_pb2.FirstSolutionStrategy
