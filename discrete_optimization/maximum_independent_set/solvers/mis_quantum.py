...
class MisQiskit(OptimizationApplication):
    ...
    def to_quadratic_program(self) -> QuadraticProgram:
        ...
        for edge in self.problem.graph_nx.edges():
            constraint = {self.problem.nodes_to_index[edge[0]]: 1, self.problem.nodes_to_index[edge[1]]: 1}
...
class QAOAMisSolver(MisSolver, QiskitQAOASolver):
    ...
    def __init__(self, problem: MisProblem, params_objective_function: Optional[ParamsObjectiveFunction] = None):
