...
class MisOrtoolsCPSatConstraintHandlerDestroy(OrtoolsCPSatConstraintHandler):
    hyperparameters = [
        FloatHyperparameter(name="fraction_to_fix", default=0.9, low=0.0, high=1.0),
    ]
...
class MisOrtoolsCPSatConstraintHandlerLocalMoves(OrtoolsCPSatConstraintHandler):
    hyperparameters = [
