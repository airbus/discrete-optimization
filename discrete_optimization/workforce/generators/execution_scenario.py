...
from allocation_and_scheduling.alloc_scheduling_problem import AllocSchedulingProblem, AllocSchedulingSolution
from allocation_and_scheduling.solvers.cpsat_alloc_scheduling_solver import AdditionalCPConstraints


class Scenario:
    def __init__(self, original_allocation_problem: TeamAllocationProblem,
        ...
        self.original_allocation_problem: TeamAllocationProblem = original_allocation_problem
        self.original_allocation_solution: TeamAllocationSolution = original_allocation_solution
    ...
    def get_current_allocation_solution(self, put_none_to_invalid_allocation: bool = True):
        sol = TeamAllocationSolution(problem=self.new_allocation_problem,
        ...
        for i in range(len(self.original_allocation_solution.allocation)):
            ...
            sol.allocation[ind_new] = self.new_allocation_problem.index_teams_name[self.original_allocation_problem.teams_name[
