...
from discrete_optimization.rcpsp.rcpsp_model import RCPSPSolution, RCPSPModel, RCPSPModelCalendar
...
def plot_ressource_view(rcpsp_model: RCPSPModel,
    ...
    sorted_activities = sorted(rcpsp_sol.rcpsp_schedule,
    ...
    array_ressource_usage = {resources[i]:
                            {"activity":
                             ...
                             np.zeros((max_time - min_time + 1,
                                       rcpsp_model.get_max_resource_capacity(resources[i]))),
                             "total_activity":
                             np.zeros(rcpsp_model.get_max_resource_capacity(resources[i])),
