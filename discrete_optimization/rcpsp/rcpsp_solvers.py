...
from discrete_optimization.rcpsp.solver.calendar_solver_iterative import SolverWithCalendarIterative
from discrete_optimization.rcpsp.solver.cp_solvers import CP_RCPSP_MZN, CP_MRCPSP_MZN, \
    CPSolverName, CP_RCPSP_MZN_PREEMMPTIVE, CP_MRCPSP_MZN_PREEMMPTIVE
from discrete_optimization.rcpsp.solver.rcpsp_lp_solver import LP_RCPSP, LP_MRCPSP, LP_RCPSP_Solver
from discrete_optimization.rcpsp.solver.rcpsp_pile import PileSolverRCPSP, PileSolverRCPSP_Calendar, GreedyChoice
...
from discrete_optimization.generic_tools.ea.ga_tools import ParametersGa, ParametersAltGa
from discrete_optimization.rcpsp.solver.rcpsp_ga_solver import GA_RCPSP_Solver, GA_MRCPSP_Solver
from discrete_optimization.rcpsp.solver.cp_lns_solver import LargeNeighborhoodSearchRCPSP
...
from discrete_optimization.rcpsp.solver.gphh_solver import GPHH, EvaluationGPHH, ParametersGPHH

from discrete_optimization.rcpsp.rcpsp_model import RCPSPModel, MultiModeRCPSPModel, \
    RCPSPModelCalendar, SingleModeRCPSPModel
from discrete_optimization.rcpsp.specialized_rcpsp.rcpsp_specialized_constraints\
    import RCPSPModelSpecialConstraints, RCPSPModelSpecialConstraintsPreemptive
from discrete_optimization.rcpsp.rcpsp_model_preemptive import RCPSPModelPreemptive


solvers = {"lp": [(LP_RCPSP, {"lp_solver": LP_RCPSP_Solver.CBC,
                              "parameters_milp": ParametersMilp.default()}),
                  (LP_MRCPSP, {"lp_solver": LP_RCPSP_Solver.CBC,
                               "parameters_milp": ParametersMilp.default()})],
           ...
           "cp": [(CP_RCPSP_MZN, {"cp_solver_name": CPSolverName.CHUFFED,
                  ...
                  (CP_MRCPSP_MZN, {"cp_solver_name": CPSolverName.CHUFFED,
                                   "parameters_cp": ParametersCP.default()}),
                  (CP_RCPSP_MZN_PREEMMPTIVE, {"cp_solver_name": CPSolverName.CHUFFED,
                                              "parameters_cp": ParametersCP.default()}),
                  (CP_MRCPSP_MZN_PREEMMPTIVE, {"cp_solver_name": CPSolverName.CHUFFED,
                                               "parameters_cp": ParametersCP.default()})],
           "critical-path": [(CPM, {})],
           "lns": [(LNS_LP_RCPSP_SOLVER, {"nb_iteration_lns": 100,
                                          "lp_solver": LP_RCPSP_Solver.CBC}),
                   (LNS_CP_RCPSP_SOLVER, {"nb_iteration_lns": 100,
                                          "nb_iteration_no_improvement": 100})],
           "lns-lp": [(LNS_LP_RCPSP_SOLVER, {"nb_iteration_lns": 100,
                                             "lp_solver": LP_RCPSP_Solver.CBC})],
           "lns-cp": [(LNS_CP_RCPSP_SOLVER, {"nb_iteration_lns": 100,
                                             "nb_iteration_no_improvement": 100})],
           "lns-cp-rcpsp": [(LargeNeighborhoodSearchRCPSP,  {"nb_iteration_lns": 100,
                                                             "nb_iteration_no_improvement": 100,
                                                             "parameters_cp": ParametersCP.default(),
                                                             "cut_part": 1,
                                                             "add_objective_makespan": False,
                                                             "fraction_subproblem": 0.6})],
           "lns-scheduling": [(LargeNeighborhoodSearchScheduling, {"nb_iteration_lns": 100,
                                                                   "nb_iteration_no_improvement": 100,
...
solvers_compatibility = {LP_RCPSP: [SingleModeRCPSPModel, RCPSPModel],
                         LP_MRCPSP: [MultiModeRCPSPModel,
                                     SingleModeRCPSPModel,
                                     RCPSPModelCalendar, RCPSPModel],
                         PileSolverRCPSP: [SingleModeRCPSPModel,
                                           MultiModeRCPSPModel, RCPSPModel],
                         PileSolverRCPSP_Calendar: [SingleModeRCPSPModel,
                                                    MultiModeRCPSPModel,
                                                    RCPSPModelCalendar, RCPSPModel],
                         CP_RCPSP_MZN: [SingleModeRCPSPModel,
                                        RCPSPModelSpecialConstraints, RCPSPModel],
                         ...
                         LS_RCPSP_Solver: [SingleModeRCPSPModel,
                                           ...
                                           RCPSPModelSpecialConstraintsPreemptive, RCPSPModel],
                         ...
                         GA_MRCPSP_Solver: [MultiModeRCPSPModel,
                                            ...
                                            RCPSPModel],
                         SolverWithCalendarIterative: [SingleModeRCPSPModel,
                                                       MultiModeRCPSPModel,
                                                       RCPSPModelCalendar,
                                                       RCPSPModel],
                         LargeNeighborhoodSearchRCPSP: [SingleModeRCPSPModel,
                                                        MultiModeRCPSPModel,
                                                        RCPSPModelCalendar,
                                                        RCPSPModelSpecialConstraints,
                                                        RCPSPModelPreemptive,
                                                        RCPSPModelSpecialConstraintsPreemptive,
                                                        RCPSPModel],
                         LargeNeighborhoodSearchScheduling: [SingleModeRCPSPModel,
                                                             MultiModeRCPSPModel,
                                                             RCPSPModelCalendar,
                                                             RCPSPModelSpecialConstraints,
                                                             RCPSPModelPreemptive,
...
def solve_return_solver(method,
                        rcpsp_model: RCPSPModel,
                        **args) -> Tuple[ResultStorage, SolverDO]:
    if method == GPHH:
        solver = GPHH([rcpsp_model], rcpsp_model, **args)
    else:
        solver = method(rcpsp_model, **args)
