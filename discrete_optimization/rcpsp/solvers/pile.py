...
class PileRcpspSolver(RcpspSolver):
    hyperparameters = [
        EnumHyperparameter(
            name="greedy_choice",
            enum=GreedyChoice,
        ...
        **kwargs,
        ...
        if problem.is_rcpsp_multimode() or problem.is_varying_resource():
            solver = CpModesMultimodeRcpspSolver(
                problem, cp_solver_name=CpSolverName.CHUFFED
            )
...
class PileCalendarRcpspSolver(RcpspSolver):
    hyperparameters = PileRcpspSolver.hyperparameters
    problem: RcpspProblem
...
class Executor(PileRcpspSolver):
    def __init__(
        self,
        problem: RcpspProblem,
        params_objective_function: Optional[ParamsObjectiveFunction] = None,
    ...
    def update(self, rcpsp_problem: RcpspProblem):
        self.mode_details = rcpsp_problem.mode_details
        self.resources = rcpsp_problem.resources
