...
from discrete_optimization.facility.solvers.greedy_solvers import GreedySolverFacility, ResultStorage
from discrete_optimization.facility.solvers.facility_lp_solver import LP_Facility_Solver_PyMip, MilpSolverName
import random
...
class ConstraintHandlerFacility(ConstraintHandler):
    ...
    def remove_constraints_from_previous_iteration(self, milp_solver: LP_Facility_Solver_PyMip,
