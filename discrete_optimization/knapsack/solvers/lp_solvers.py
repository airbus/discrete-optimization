from discrete_optimization.knapsack.knapsack_model import Item, KnapsackModel, KnapsackSolution
from typing import Dict, Iterable
from gurobi import LinExpr, Model, GRB, quicksum
from ortools.linear_solver import pywraplp
from ortools.algorithms import pywrapknapsack_solver
from discrete_optimization.generic_tools.lp_tools import ParametersMilp, MilpSolverName
...
from discrete_optimization.generic_tools.mip.pymip_tools import MyModelMilp, CBC, \
...
class LPKnapsackCBC(SolverDO):
    def __init__(self, knapsack_model: KnapsackModel,
                 params_objective_function: ParamsObjectiveFunction=None, **args):
        self.knapsack_model = knapsack_model
        self.model = None
        self.variable_decision = {}
        self.constraints_dict = {}
