...
dictionnary_mutation[TypeAttribute.PERMUTATION_TSP] = {
    "2opt": (Mutation2Opt, {"test_all": False, "nb_test": 200}),
    "2opt_interection": (Mutation2OptIntersection, {"test_all": False, "nb_test": 200}),
...
dictionnary_mutation[TypeAttribute.PERMUTATION_RCPSP] = {
    ...
    "deadline": (PermutationMutationRCPSP, {"other_mutation": DeadlineMutationRCPSP}),
...
dictionnary_mutation[TypeAttribute.LIST_BOOLEAN_KNAP] = {
...
dictionnary_mutation[TypeAttribute.VRP_PATHS] = {
