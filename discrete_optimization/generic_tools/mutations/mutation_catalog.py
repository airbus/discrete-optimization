...
from discrete_optimization.tsp.mutation.mutation_tsp import Mutation2Opt, Mutation2OptIntersection, MutationSwapTSP
from discrete_optimization.knapsack.mutation.mutation_knapsack import MutationKnapsack, KnapsackMutationSingleBitFlip
from discrete_optimization.rcpsp.mutations.mutation_rcpsp import PermutationMutationRCPSP, DeadlineMutationRCPSP
from discrete_optimization.generic_tools.mutations.mutation_integer import MutationIntegerSpecificArrity
from discrete_optimization.vrp.mutation.mutation_vrp import MutationRelocate, MutationSwap, MutationTwoOptVRP
...
dictionnary_mutation[TypeAttribute.PERMUTATION_RCPSP] = {"total_shuffle_rcpsp":
                                                         ...
                                                         "deadline": (PermutationMutationRCPSP,
                                                                    ...
                                                                    "random_flip_modes_rcpsp":
                                                                        (PermutationMutationRCPSP,
                                                                         {"other_mutation":
                                                                          ...
                                                                          "probability_flip": 0.1})}
dictionnary_mutation[TypeAttribute.VRP_PATHS] = {"relocate": (MutationRelocate, {}),
                                                 "swap": (MutationSwap, {}),
                                                 "2opt": (MutationTwoOptVRP, {"test_all": False,
                                                                              "nb_test": 200})}
