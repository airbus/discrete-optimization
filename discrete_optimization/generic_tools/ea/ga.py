...
class Ga():
    ...
    def __init__(self, problem: Problem,
        ...
        # TODO : adapt to floating variable
            ...
            gen_idx = lambda: [random.randrange(0, arrity - 1) for arrity in self.arrities]
            self._toolbox.register("individual", tools.initIterate, creator.individual, gen_idx)
    ...
    # elif self._encoding_type == TypeAttribute.PERMUTATION:
        ...
        if isinstance(self._mutation, Mutation):
            self._toolbox.register("mutate", generic_mutate_wrapper, problem=self.problem,
                                   encoding_name=self._encoding_variable_name, indpb=self._mut_rate,
