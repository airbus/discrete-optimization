...
from discrete_optimization.generic_tools.ea.ga import DeapMutation, DeapSelection, DeapCrossover, Ga
...
class AlternatingGa:
    ...
    def __init__(self, problem: Problem,
        ...
        self.aggreg_from_sol, self.aggreg_dict, self.params_objective_function = \
            build_aggreg_function_and_params_objective(problem=self.problem, params_objective_function=None)
