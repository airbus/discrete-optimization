from discrete_optimization.generic_tools.do_problem import MethodAggregating, BaseMethodAggregating, Problem, \
...
from discrete_optimization.rcpsp.rcpsp_model import RCPSPSolution, Aggreg_RCPSPModel, RCPSPModel
