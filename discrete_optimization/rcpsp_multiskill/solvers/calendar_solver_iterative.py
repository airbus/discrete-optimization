...
from discrete_optimization.rcpsp_multiskill.solvers.ms_rcpsp_lp_lns_solver import InitialSolutionMS_RCPSP, InitialMethodRCPSP
from discrete_optimization.rcpsp_multiskill.solvers.ms_rcpsp_cp_lns_solver import ConstraintHandlerStartTimeInterval_CP,\
    build_neighbor_operator, OptionNeighbor
from discrete_optimization.generic_tools.cp_tools import ParametersCP, CPSolverName
from discrete_optimization.rcpsp_multiskill.solvers.cp_solvers import CP_MS_MRCPSP_MZN, PartialSolution
...
from discrete_optimization.rcpsp_multiskill.rcpsp_multiskill import MS_RCPSPModel, MS_RCPSPSolution, \
    MS_RCPSPModel_Variant, MS_RCPSPSolution_Variant, schedule_solution_to_variant
from discrete_optimization.rcpsp_multiskill.solvers.lns_post_process_rcpsp import sgs_variant
import numpy as np
import time
        ...
        for t in task_concerned[r]:
            ...
            first_possible_start_before = next((st-problem_calendar.mode_details[t][1]["duration"]+1
                                               ...
                                               if problem_calendar.resources_availability[r][st-1]
                                                >= problem_calendar.mode_details[t][1][r]
                                                and problem_calendar.resources_availability[r][max(0,
...
class SolverWithCalendarIterative(SolverDO):
    def __init__(self, problem_calendar: MS_RCPSPModel, partial_solution: PartialSolution=None,
        ...
        solver.init_model(output_type=True,
                          ...
                          exact_skills_need=False, **kwargs)
                ...
                try:
                    ...
                    if len(result_store.list_solution_fits) > 0:
                        ...
                        if skip_first_iteration and iteration == 0:
                            ...
                            store_with_all = ResultStorage(list_solution_fits=
