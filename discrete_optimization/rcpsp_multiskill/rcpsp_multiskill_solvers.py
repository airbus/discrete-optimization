...
from discrete_optimization.rcpsp_multiskill.solvers.calendar_solver_iterative import SolverWithCalendarIterative
...
from discrete_optimization.rcpsp_multiskill.solvers.lp_model import LP_Solver_MRSCPSP, MilpSolverName
from discrete_optimization.rcpsp_multiskill.solvers.ms_rcpsp_cp_lns_solver import LNS_CP_MS_RCPSP_SOLVER, OptionNeighbor
...
from discrete_optimization.rcpsp_multiskill.solvers.ms_rcpsp_ga_solver import GA_MSRCPSP_Solver
from discrete_optimization.rcpsp_multiskill.solvers.cp_lns_solver import LargeNeighborhoodSearchMSRCPSP

solvers = {"lp": [(LP_Solver_MRSCPSP, {"lp_solver": MilpSolverName.CBC,
                                       "parameters_milp": ParametersMilp.default()})],
           "cp": [(CP_MS_MRCPSP_MZN, {"cp_solver_name": CPSolverName.CHUFFED,
                                      "parameters_cp": ParametersCP.default(),
                                      "exact_skills_need": False}),
                  (CP_MS_MRCPSP_MZN_PREEMPTIVE, {"cp_solver_name": CPSolverName.CHUFFED,
                                                 "parameters_cp": ParametersCP.default(),
                                                 "exact_skills_need": False,
                                                 "nb_preemptive": 5})],
           ...
           "lns-cp-rcpsp": [(LargeNeighborhoodSearchMSRCPSP,  {"nb_iteration_lns": 100,
